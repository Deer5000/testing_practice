...
def get_age_carbon_14_dating(carbon_14_ratio):
    ...
    if carbon_14_ratio <= 0:
        return print("Invalid entry. Must be a positive number above 0.")
    else:
...
def test_get_neg_age_carbon_14_dating():
    carbon_14_ratio = 0.35
    assert get_age_carbon_14_dating(carbon_14_ratio) == print("invalid entry")

# def get_char_age_carbon_14_dating():
#     carbon_14_ratio = g7
#     assert 
